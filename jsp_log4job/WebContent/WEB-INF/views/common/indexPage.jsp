...
<body class="mod-bg-1 mod-nav-link ">
			...
			<aside class="page-sidebar">
				<div class="page-logo">
					<a href="#"
						...
						src="<%=request.getContextPath()%>/resources/template/img/logo.png"
						alt="SmartAdmin WebApp" aria-roledescription="logo"> <span
						class="page-logo-text mr-1">Log4Job</br>취업정보시스템
					</span> <span
				...
				<nav id="js-primary-nav" class="primary-nav" role="navigation">
						...
						<div class="info-card-text">
							<a href="#" class="d-flex align-items-center text-white"> <span
								class="text-truncate text-truncate-sm d-inline-block">
									<div class="row">
										<a
											href="javascript:OpenWindow('<%=request.getContextPath() %>/member/detail.do?id=${loginUser.id }','내정보','700','800');"
											class="d-block">${loginUser.name }</a>&nbsp;&nbsp;
									</div>
							</span>
							</a> <span class="d-inline-block text-truncate text-truncate-sm"><a
								href="tel:${loginUser.phone }">tel : ${loginUser.phone}</a></span> <span
								class="d-inline-block text-truncate text-truncate-sm"><a
								href="mailto:${loginUser.email }">email : ${loginUser.email }</a></span>
						</div>
						<img
					...
					<div class="nav-footer shadow-top">
						...
						<ul class="list-table m-auto nav-footer-buttons">
							<li><a href="javascript:void(0);" data-toggle="tooltip"
								data-placement="top" title="마이페이지"> <i
									class="fal fa-life-ring"></i> <span class="nav-link-text"
									data-i18n="nav.application_intel">My Page</span>
							</a></li>
							<li><a href="common/logout.do" data-toggle="tooltip"
								data-placement="top" title="로그아웃"> <i
									class="fal fa-sign-out"></i> <span class="nav-link-text"
									data-i18n="nav.application_intel">Logout</span>
							</a></li>
						</ul>
					</div>
					<!-- 마이페이지 / 로그아웃 -->
					<ul id="js-nav-menu" class="nav-menu">
						<c:forEach items="${menuList }" var="menu">
							<li><a
								href="javascript:subMenu_go('${menu.mcode }');goPage('${menu.murl}','${menu.mcode }');"
								title="Application Intel" data-filter-tags="application intel">
									<i class="fal fa-cube""></i> <span class="nav-link-text"
									data-i18n="nav.application_intel">${menu.mname}</span>
							</a>
								<ul>
									<c:forEach items="${subMenuList}" var="subMenu">
										<li><a href="#" title="Analytics Dashboard"
											data-filter-tags="application intel analytics dashboard">
												<span class="nav-link-text"
												data-i18n="nav.application_intel_analytics_dashboard">${subMenu.mname}</span>
										</a></li>
									</c:forEach>
								</ul></li>
						</c:forEach>
				...
				<header class="page-header" role="banner">
					...
					<div class="search">
						<form class="app-forms hidden-xs-down" role="search"
							...
							<input type="text" id="search-field" placeholder="무엇이든 검색해보세요"
								class="form-control" tabindex="1"> <a href="#"
								onclick="return false;"
					...
					<div class="ml-auto d-flex">
						...
						<div>
							<a href="#" class="header-icon" data-toggle="dropdown"
								title="바로가기"> <i class="fal fa-cube"></i>
							</a>
							...
							<div class="dropdown-menu dropdown-menu-animated dropdown-lg">
								<div
									...
									<div
										...
										<span class="mr-2"> <img
											src="<%=request.getContextPath()%>/resources/template/img/demo/avatars/avatar-admin.png"
					...
					<div class="row">
						...
						<div class="col-md-2 "
							...
							<div class="form-group">
								<label class="form-label" for="example-multiselect"><h1>업종</h1></label>
								<select id="example-multiselect" multiple=""
									...
									<option style="font-size: 1.5em;">2</option>
									<option style="font-size: 1.5em;">3</option>
									<option style="font-size: 1.5em;">4</option>
									<option style="font-size: 1.5em;">5</option>
								</select>
							</div>
						</div>
						<div class="col-md-2 "
							...
							<div class="form-group">
								...
								<select id="example-multiselect" multiple=""
									class="form-control" style="height: 200px;">
									<option style="font-size: 1.5em;">1</option>
									<option style="font-size: 1.5em;">2</option>
									<option style="font-size: 1.5em;">3</option>
									<option style="font-size: 1.5em;">4</option>
									<option style="font-size: 1.5em;">5</option>
						...
						<div class="col-md-2 " style="border-left: 1px solid black; border-top: 1px solid black; border-right :1px solid black; ">
						...
						<div class="col-md-10 "
							...
							<div class="form-group">
								<button type="button"
									...
									style="float: right;">Success</button>
							</div>
						</div>
								...
								<ul class="app-list w-auto h-auto p-0 text-left">
									...
									<li><a href="page_inbox_general.html"
										class="app-list-item text-white border-0 m-0">
											...
											</div> <span class="app-list-name"> AI Service </span>
									</a></li>
									<li><a href="intel_introduction.html"
										class="app-list-item text-white border-0 m-0">
											<div class="icon-stack">
	...
	<nav class="shortcut-menu d-none d-sm-block">
		<input type="checkbox" class="menu-open" name="menu-open"
			...
			data-placement="left" title="상단으로가기"> <i class="fal fa-arrow-up"></i>
		</a> <a href="page_login.html" class="menu-item btn" data-toggle="tooltip"
			data-placement="left" title="로그아웃"> <i class="fal fa-sign-out"></i>
	...
	<script>
		$(document).ready(
				function() {
					...
					$('input[type=radio][name=contactview]').change(
							function() {
								if (this.value == 'grid') {
									$('#js-contacts .card').removeClassPrefix(
											'mb-').addClass('mb-g');
									$('#js-contacts .col-xl-12')
											.removeClassPrefix('col-xl-')
											.addClass('col-xl-4');
									$('#js-contacts .js-expand-btn').addClass(
											'd-none');
									$('#js-contacts .card-body + .card-body')
											.addClass('show');
