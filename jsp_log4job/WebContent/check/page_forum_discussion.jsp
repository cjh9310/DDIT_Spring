...
<head>
<meta charset="utf-8">
<title>Item - Page Views - SmartAdmin v4.5.1</title>
...
<link rel="mask-icon"
	href="<%=request.getContextPath()%>/resources/img/favicon/safari-pinned-tab.svg"
	color="#5bbad5">
			...
			<aside class="page-sidebar">
				...
				<nav id="js-primary-nav" class="primary-nav" role="navigation">
					...
					<ul id="js-nav-menu" class="nav-menu">
						...
						<li class="active open"><a href="#" title="Pages"
							data-filter-tags="pages"> <i class="fal fa-plus-circle"></i>
								<span class="nav-link-text" data-i18n="nav.pages">Page
									Views</span>
						</a>
							<ul>
								...
								<li class="active open"><a href="javascript:void(0);"
									title="Forum" data-filter-tags="pages forum"> <span
										class="nav-link-text" data-i18n="nav.pages_forum">Forum</span>
								</a>
									<ul>
										...
										<li class="active"><a href="page_forum_discussion.html"
			...
			<div class="page-content-wrapper">
				...
				<div class="subheader">
					<h1 class="subheader-title">
						<i class='subheader-icon fal fa-plus-circle'></i> 채용공고 : <span
							class='fw-300'>상세정보</span> <small> 기업 상세정보 </small>
					</h1>
				</div>
...
\
								...
								<div class="row">
									<div class="col-xl-12">
										<div class="careers-new">
												...
												<div class="left">
													...
													<div class="info">
														...
														<div class="column">
															...
															<div class="cont">
																<ul>
																	<li><strong>지역</strong> <span>인천광역시 연수구
																			청능대로 210, 스퀘어원 (동춘동)</span></li>
												...
												<div class="right">
													<div class="logo-company">
														...
														<div class="btn" style="font-size: 12px;">
															<a href="#none" onclick="f_companyInfoPop()"
																title="새창 열림" class="button mg00 pd00">채용정보이력</a>
															<button type="button" onclick="f_interestCompany();"
																class="button mg00 pd00-05">
																<i id="interestCompanyId"
																	class="iconset ico-heart-off fav-com"></i> 스크랩
															</button>
															<button type="button" onclick="f_blockCompany();"
																class="button mg00 pd00">
																<i id="blockCompanyId"
																	class="iconset ico-prohibit-gray block-com"></i> 거짓구인신고
															</button>
														</div>
											...
											<div class="btn-group center scrap-group" id="button-submit">
												<button type="button" class="button blue" id="btnSubmit" title="새창"
													onclick="f_resumePop()">
													<i class="iconset ico-email-white"></i> 지원하기
												</button>
				...
				<footer class="page-footer" role="contentinfo">
					<div class="d-flex align-items-center flex-1 text-muted">
						<span class="hidden-md-down fw-700">2020 Â© SmartAdmin
