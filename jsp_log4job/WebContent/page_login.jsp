...
<html lang="en">
    <head>
        ...
        <link rel="mask-icon" href="<%=request.getContextPath()%>/resources/template/mg/favicon/safari-pinned-tab.svg" color="#5bbad5">
    ...
    <body>
        ...
        <div class="page-wrapper auth">
            <div class="page-inner bg-brand-gradient">
                <div class="page-content-wrapper bg-transparent m-0">
                    ...
                    <div class="flex-1" style="background: url(<%=request.getContextPath()%>/resources/template/img/svg/pattern-1.svg) no-repeat center bottom fixed; background-size: cover;">
        ...
        <video poster="img/backgrounds/clouds.png" id="bgvid" playsinline autoplay muted loop>
            ...
            <source src="<%=request.getContextPath()%>/resources/template/media/video/daejeon_loginForm.mp4" type="video/mp4">
        </video>
        <!-- BEGIN Color profile -->
