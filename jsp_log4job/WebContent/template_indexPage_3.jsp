...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
            ...
            <div class="page-inner">
                ...
                <aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="<%=request.getContextPath()%>/resources/template/img/demo/avatars/avatar-admin.png" class="profile-image rounded-circle" alt="회원사진">
                        ...
                        <ul class="list-table m-auto nav-footer-buttons">
                            <li>
                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="마이페이지">
                                    <i class="fal fa-comments"></i>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="로그아웃">
                                    <i class="fal fa-life-ring"></i>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="AI Service 이용내역">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="<%=request.getContextPath()%>/resources/template/img/demo/avatars/avatar-admin.png" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
        ...
        <nav class="shortcut-menu d-none d-sm-block">
            ...
            <a href="#" class="menu-item btn" data-toggle="tooltip" data-placement="left" title="상단으로가기">
